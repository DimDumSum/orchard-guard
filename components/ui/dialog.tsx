  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        style={{ background: '#18181B', border: '1px solid #27272A', boxShadow: '0 20px 60px rgba(0,0,0,0.7)' }}
        className={cn(
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t border-[#27272A] bg-[#1c1c1f] p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
